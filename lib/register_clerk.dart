...
import 'package:fibeco_qms/register.dart';
//import 'package:fibeco_qms/teacher_clerk.dart';
import 'login.dart';
// import 'model.dart';

class RegisterClerk extends StatefulWidget {
  @override
  _RegisterState createState() => _RegisterState();
}

class _RegisterState extends State<RegisterClerk> {
  _RegisterState();
                          ...
                          children: [
                            ...
                            DropdownButton<String>(
                              ...
                              onChanged: (newValueSelected) {
                                setState(() {
                                  if (newValueSelected == "Student" &&
                                      _currentItemSelected != "Student") {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
